...
export class AdminService {
  ...
  async listPermissions(actor: AdminTokenPayload) {
    await this.access.assert(actor, 'roles.view');
    const floorPermissions = [
      ['halls.view', 'View halls'], ['halls.create', 'Create halls'], ['halls.update', 'Edit halls'], ['halls.pause', 'Pause halls'], ['halls.order', 'Order halls'], ['halls.delete', 'Delete halls'],
      ['tables.view', 'View tables'], ['tables.create', 'Create tables'], ['tables.update', 'Edit tables'], ['tables.pause', 'Pause tables'], ['tables.order', 'Order tables'], ['tables.delete', 'Delete tables'],
    ] as const;
    await Promise.all(floorPermissions.map(([code, description]) => this.prisma.permission.upsert({ where: { code }, update: { description }, create: { code, description } })));
